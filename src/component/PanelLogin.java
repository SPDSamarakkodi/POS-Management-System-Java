...
public class PanelLogin extends javax.swing.JLayeredPane {
    ...
    public void   dbconnectadmin(){
        //ADMIN
        /*we never conduct any processes in this 
 function related to the logIn of the admin. just sending the data to the --> Model package. according to the MVC design */
        String adminName = null,password = null;
        if(txtadminusername.getText().equals("")|| txtadminpass.getText().equals(""))
        {
          JOptionPane.showMessageDialog(null,"Please Insert All valus");
        }
        else{
            dbconnectResources R1 = new dbconnectResources();
           R1.setName(txtadminusername.getText());
           R1.setPass(String.valueOf(txtadminpass.getPassword()));
           dbconnectProcess.adminLogIn(R1);
        }
